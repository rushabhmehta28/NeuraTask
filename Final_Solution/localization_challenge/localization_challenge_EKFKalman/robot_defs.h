...
Eigen::Matrix<double,(3*4) + 3,1> eigRobotState;

Eigen::MatrixXd  covRobot = Eigen::MatrixXd::Zero((3*NUM_LANDMARKS)+3,(3*NUM_LANDMARKS)+3);

std::vector<bool> seen(NUM_LANDMARKS);

Eigen::MatrixXd  sensorNoise = Eigen::MatrixXd::Zero(3,3);
Eigen::MatrixXd  odomNoise = Eigen::MatrixXd::Zero(3,3);
